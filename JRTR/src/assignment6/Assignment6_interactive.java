...
//		interactivityDemo();
	...
	private static void pickingDemo() throws Exception{
		...
		//The DeformationPickingProcessor will handle picking, 
		//and look to that the  RAPS_modelling class gets user
		//constraints
	...
	private static void interactivityDemo() throws IOException,
